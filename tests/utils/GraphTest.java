...
class GraphTest {
    ...
    void equals() {
        ...
        assertNotEquals(new Graph.Edge(1, 1, 0), new Object());

        Graph.Edge edge1 = new Graph.Edge(1, 2, 1);
        Graph.Edge edge2 = new Graph.Edge(1, 2, 1);
        Graph.Edge edge3 = new Graph.Edge(1, 2, 2);
        Graph.Edge edge4 = new Graph.Edge(1, 3, 2);
        Graph.Edge edge5 = new Graph.Edge(2, 3, 2);
    ...
    void outgoingEdges() {
        ...
        for (int i = 1; i < graphs.length; i++) {
            assertEquals(outgoingEdges[i-1], graphs[i].outgoingEdges(i-1).size());
        }
    }
    @Test
    void incomingEdges() {
        ...
        for (int i = 1; i < graphs.length; i++) {
            assertEquals(incomingEdges[i-1], graphs[i].incomingEdges(i-1).size());
        }
    }
    @Test
    void bothWayEdges() {
    ...
    void clique() {
        ...
        Set<Integer> clique = imitateNumbers.clique(3, 19);
